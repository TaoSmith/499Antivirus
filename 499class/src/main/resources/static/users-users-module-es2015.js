...
function ListComponent_tr_12_Template(rf, ctx) { if (rf & 1) {
    ...
    const scanhistory_r2 = ctx.$implicit;
...
ListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ListComponent, selectors: [["ng-component"]], decls: 14, vars: 2, consts: [[1, "table", "table-striped"], [2, "width", "33%"], [4, "ngFor", "ngForOf"], [4, "ngIf"], ["colspan", "4", 1, "text-center"], [1, "spinner-border", "spinner-border-lg", "align-center"]], template: function ListComponent_Template(rf, ctx) { if (rf & 1) {
